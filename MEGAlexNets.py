...
class AlexNetMPSFinalOnly(nn.Module, LayerFreezeResetMixin):
    def __init__(self):
        super().__init__()
...
class AlexNetMPSSuddenDescend(nn.Module, LayerFreezeResetMixin):
    def __init__(self):
        super().__init__()
...
class AlexNetMPSLongDescend(nn.Module, LayerFreezeResetMixin):
    def __init__(self):
        super().__init__()
        self.model = models.alexnet(weights=models.AlexNet_Weights.IMAGENET1K_V1)
...
class AlexNetMPSDescend(nn.Module, LayerFreezeResetMixin):
    def __init__(self):
        super().__init__()
        self.model = models.alexnet(weights=models.AlexNet_Weights.IMAGENET1K_V1)
